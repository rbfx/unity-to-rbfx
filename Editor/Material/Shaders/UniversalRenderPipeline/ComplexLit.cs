...
{
    public class ComplexLitShaderAdapter
    {
        public static readonly string ShaderName = "Universal Render Pipeline/Complex Lit";

        UnityEngine.Material material;

        public ComplexLitShaderAdapter(UnityEngine.Material material)
        {
        ...
        public float _ClearCoat
        {
            get { return material.GetFloat("_ClearCoat"); }
        }


        public UnityEngine.Texture _ClearCoatMap
        {
            get { return material.GetTexture("_ClearCoatMap"); }
        }
